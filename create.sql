...
CREATE TABLE INTEREST (
  ...
  INDEX FK_INTEREST_USER_idx (user_id ASC),
  INDEX FK_INTEREST_FESTIVAL_idx (festival_id ASC),
  CONSTRAINT FK_INTEREST_USER
    FOREIGN KEY (user_id)
    REFERENCES USER (user_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT FK_INTEREST_FESTIVAL
...
CREATE TABLE POST (
  ...
  INDEX FK_POST_FESTIVAL_idx (festival_id ASC),
  CONSTRAINT FK_POST_USER
    FOREIGN KEY (user_id)
    REFERENCES USER (user_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT FK_POST_FESTIVAL
    FOREIGN KEY (festival_id)
    REFERENCES FESTIVAL (festival_id)
    ON DELETE CASCADE
    ON UPDATE CASCADE);
